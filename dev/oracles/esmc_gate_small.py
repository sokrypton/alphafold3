...
more than one at layer 3.
  ...
  ~/venv_esm/bin/python dev/oracles/esmc_gate_small.py \
...
def dump_native(hub_dir, seq, out):
  ...
  from alphafold3.model.esm import sequence_ids, lm_input_ids
  ...
  # alphafold3.model.esm.forward reproduces.
  hs = o.hidden_states
...
def compare(model_dir, native_npz, seq):
  from alphafold3.model import esm as esmc_embed
